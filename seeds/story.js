  ...
  return knex('story').del()
    .then(function () {
      ...
      return knex('story').insert([
        ...
        {id: 2, iwi_id:1, title:'Te Aro Pa', latitude:'-41.291800', longitude:'174.777425', content:"ssstttttttttttooooooooooooooooorrrrrrrrrrrrrryyyyyyyyyyyyyyyy", image:'https://teara.govt.nz/files/a13194atl.jpg'},
        {id: 3, iwi_id:2, title:'Te Aro Pa', latitude:'-41.291800', longitude:'174.777425', content:"Super fake story data, what", image:'https://teara.govt.nz/files/a13194atl.jpg'}
      ]);
    });
};
